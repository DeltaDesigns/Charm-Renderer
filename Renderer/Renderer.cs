    ...
    private void Render()
    {
        ...
        switch (DisplayPass)
        {
            case RenderPass.Albedo:
                RenderGlobalPipeline("debug_source_color");
                break;
            case RenderPass.Normals:
                RenderGlobalPipeline("debug_world_normal");
                break;
            case RenderPass.Metal:
                RenderGlobalPipeline("debug_metalness");
                break;
            case RenderPass.AO:
                RenderGlobalPipeline("debug_ambient_occlusion");
                break;
            case RenderPass.Smoothness:
                RenderGlobalPipeline("debug_specular_smoothness");
                break;
            case RenderPass.Emissive:
                RenderGlobalPipeline("debug_emissive");
                break;
        }
