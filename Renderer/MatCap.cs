...
public class MatCap : GpuResource
{
    ...
    public MatCap(DeviceContext context)
    {
        ...
        MatCapDiffuse = TextureLoader.FromFileAsShaderResourceView(context.Device, "textures/matcap.png", true);
        MatCapDiffuse.DebugName = "MatCap Diffuse";

        MatCapSpecular = TextureLoader.FromFileAsShaderResourceView(context.Device, "textures/matcap_specular.png", true);
