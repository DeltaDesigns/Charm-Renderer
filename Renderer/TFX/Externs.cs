...
public class Externs : IDisposable
{
    ...
    public class ExternFrame : IDisposable
    {
        ...
        [ExternField(0x18)] public float ExposureTime { get; set; } = 1f;
        [ExternField(0x1C)] public float ExposureScale { get; set; } = 1f;
    ...
    public class ExternDeferred : IDisposable
    {
        ...
        public void Update(DeviceContext context, GBuffer gbuffer)
        {
            ...
            LightDiffuse = gbuffer.LightDiffuse.SRV;
            LightSpecular = gbuffer.LightSpecular.SRV;
            LightIBL = gbuffer.LightIBL.SRV;
        }
